        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    I'm a multi-platform full-stack developer.
                    I find versatile answers for complex
                    scenarios in an artistic manner.
                    My goal is to build solutions that provides
                    both exceptional performance and delightful
                    user experience.
                </p>
